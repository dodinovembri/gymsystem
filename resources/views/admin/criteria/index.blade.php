...
<div class="content">
  ...
  <div class="content-header">
    <div>
      ...
      <h4 class="content-title content-title-xs">Criteria List</h4>
    </div>
  </div><!-- content-header -->
              ...
              <table id="example1" class="table">
                ...
                <tbody>
                  <?php $no = 0; foreach ($criteria as $key => $value) { $no++; ?>
                    <tr>
                      <td>{{ $no }}</td>
                      <td><a href="{{ route('admin.criterion_value.index', $value->id) }}"><u><b>{{ $value->name }}</b></u></a></td>
                      <td>{{ $value->attribute }}</td>                                                         
                      <td>{{ $value->weight }} %</td>                                                         
                      <td>
                        <a href="{{ route('admin.criteria.show', $value->id) }}"><i class="fa fa-eye"></i></a> 
                        <a href="{{ route('admin.criteria.edit', $value->id) }}"><i class="fa fa-edit" style="margin-left: 8px"></i></a> 
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="{{ route('admin.criteria.destroy', $value->id) }}"><button type="button" class="btn btn-dark rounded-5">Delete</button></a>
                          </div>
                        </div>
                      </div>
                    </div>             
