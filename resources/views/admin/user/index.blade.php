...
<div class="content">
  ...
  <div class="content-header">
    <div>
      ...
      <h4 class="content-title content-title-xs">Users List</h4>
    </div>
  </div><!-- content-header -->
                  ...
                  <?php $no = 0; foreach ($user as $key => $value) { $no++; ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.user.edit', $value->id) }}"><i class="fa fa-edit" style="margin-left: 8px"></i></a> 
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="{{ route('admin.user.destroy', $value->id) }}"><button type="button" class="btn btn-dark rounded-5">Delete</button></a>
                          </div>
                        </div>
                      </div>
                    </div>             
