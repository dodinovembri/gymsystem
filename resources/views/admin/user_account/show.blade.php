		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Alternative Detail</li>
				</ol>
			</nav>
			<h4 class="content-title content-title-xs">Alternative Detail</h4>
		</div>
	</div><!-- content-header -->
						...
						<form method="POST" action="#">
							...
							<div class="row row-sm">
								...
								<div class="col-sm-10" style="margin-top: 20px">								
									<a href="{{ route('admin.alternative.index') }}"><button type="button" class="btn btn-secondary rounded-5">Back to List</button></a>
								</div><br><br><br>							
							</div><!-- row -->
						</form>
