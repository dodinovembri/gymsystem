    ...
    <div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Users Account List</li>
        </ol>
      </nav>
      <h4 class="content-title content-title-xs">Users Account List</h4>
    </div>
  </div><!-- content-header -->
  <div class="content-body">
    <div class="component no-code">
      <div class="card rounded-5">
        <div class="card-body">       
          <div class="component">
            <a href="{{ route('admin.user_account.create') }}">
            ...
            <div class="table table-responsive">
              <table id="example1" class="table">
                ...
                <tbody>
                  <?php $no = 0; foreach ($user_account as $key => $value) { $no++; ?>
                    <tr>
                      <td>{{ $no }}</td>
                      <td>{{ $value->name }}</td>                      
                      <td>{{ $value->email }}</td>                                                         
                      ...
                      <?php }elseif($value->status == 1){ ?>
                        ...
                        <?php } ?></a></td>                                                                               
                        <td>
                          <a href="{{ route('admin.user_account.show', $value->id) }}"><i class="fa fa-eye"></i></a> 
                          <a href="{{ route('admin.user_account.edit', $value->id) }}"><i class="fa fa-edit" style="margin-left: 8px"></i></a> 
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <a href="{{ route('admin.user_account.destroy', $value->id) }}"><button type="button" class="btn btn-dark rounded-5">Delete</button></a>
                            </div>
                          </div>
                        </div>
                      </div>             
