...
class GymController extends Controller
{
    ...
    {
        $data['altenative'] = AlternativeModel::all();
    ...
    {
        $data['information'] = AlternativeModel::find($id);
        $data['gym'] = DB::select("SELECT alternative_value.*, criteria.name AS name, criterion_value.description AS description, criterion_value.value AS value_criteria FROM alternative_value JOIN criteria ON alternative_value.criteria_id = criteria.id JOIN criterion_value ON alternative_value.criterion_value_id = criterion_value.id WHERE alternative_value.alternative_id = $id");
        return view('fe.gym.show', $data);
    }
